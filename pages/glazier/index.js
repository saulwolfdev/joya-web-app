	    ...
	    {/* <div class="main-content">
	    	...
	    	<div class="home-beneficios-vidrierista section">
	    		<div class="container-fluid">
	    			...
	    			<div class="row">
	    				<div class="col-sm-6 col-md-4 beneficio-vidrierista">
	    					<div class="img-block"><img class="img-fluid" src="../assets/img/beneficio-v1.jpg" alt="Solicitá un vidrierista" width="112" height="82"></div>
	    					<div class="text">
	    				...
	    				<div class="col-sm-6 col-md-4 beneficio-vidrierista">
	    					<div class="img-block"><img class="img-fluid" src="../assets/img/beneficio-v2.jpg" alt="Elegí día, horario y frecuencia" width="110" height="108"></div>
	    					<div class="text">
	    				...
	    				<div class="col-sm-6 col-md-4 beneficio-vidrierista">
							<div class="img-block"><img class="img-fluid" src="../assets/img/beneficio-v3.jpg" alt="Pago seguro" width="114" height="74"></div>
							<div class="text">
