	    		...
	    		<div className="container-fluid">
	    			<div className="row">
	    				<div className="col step">
		    					...
		    					<div className="img-block"><img className="img-fluid" src={require('../assets/img/step1.jpg')} alt="Solicitá un vidrierista" width="80" height="67"/></div>
		    					<div className="text">
	    				...
	    				<div className="col step">
		    					...
		    					<div className="img-block"><img className="img-fluid" src="/img/step2.jpg" alt="Elegí día, horario y frecuencia" width="67" height="68"/></div>
		    					<div className="text">
	    				...
	    				<div className="col step">
		    					...
		    					<div className="img-block"><img className="img-fluid" src="/img/step3.jpg" alt="Pago seguro" width="76" height="67"/></div>
		    					<div className="text">
	    		...
	    		<div className="container-fluid">
		    		<div className="row">
		    			<div className="col-md-7 col-lg-6 beneficios">
		    				...
		    				<div className="row">
		    					<div className="beneficio col-6">
			    					<div className="img-block"><img className="img-fluid" src="/img/xq_01.jpg"  width="130" height="80" alt="Mejorá la exposición de tus productos"/></div>
			    					<div className="text">
		    					...
		    					<div className="beneficio col-6">
			    					<div className="img-block">
			    						<img className="img-fluid" src="/img/xq_02.jpg"  width="142" height="86" alt="Programá tus visitas y despreocupate"/>
			    					</div>
			    					<div className="text">
		    					...
		    					<div className="beneficio col-6">
			    					<div className="img-block"><img className="img-fluid" src="/img/xq_03.jpg"  width="111" height="102" alt="Mantené tus empleados enfocados"/></div>
			    					<div className="text">
		    					...
		    					<div className="beneficio col-6">
			    					<div className="img-block"><img className="img-fluid" src="/img/xq_04.jpg"  width="117" height="91" alt="Evitá movimientos confusos de caja"/></div>
			    					<div className="text">
		    					...
		    					<div className="beneficio col-6">
			    					<div className="img-block"><img className="img-fluid" src="/img/xq_05.jpg"  width="119" height="106" alt="Evitá el trabajo informal"/></div>
			    					<div className="text">
		    					...
		    					<div className="beneficio col-6">
			    					<div className="img-block"><img className="img-fluid" src="/img/xq_06.jpg"  width="130" height="112" alt="Cubrite ante urgencias"/></div>
			    					<div className="text">
		    			...
		    			<div className="col-md-5 offset-lg-1 miscelaneas">	    				
		    				<img className="img-fluid d-none d-md-block" src="/img/beneficios-side.jpg" width="495" height="784" alt="Joya se ocupa de que tu vidriera esté siempre limpia" />
		    			</div>
		    		</div>
	    		</div>
	    	</div>
	    		...
	    		<div className="container-fluid">
	    			<div className="row">
	    				<div className="offset-lg-1 col-md-4 misc col-12">
	    				   <img src="/img/vidrierista.jpg" alt="Podes ser vidrierista de Joya" className="img-fluid" width="302" height="220"/>	
	    				</div>
