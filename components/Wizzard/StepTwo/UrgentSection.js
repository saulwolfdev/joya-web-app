...
const UrgentSection = ({handleUrgentDate, isFlexibleUrgent, handleUrgentTimeZone}) => {
    return (
        <div className="frequency-form active" id="freq-urgencia">
            ...
            <Schedule handleDate={handleUrgentDate} isFlexible={isFlexibleUrgent} handleTimeZone={handleUrgentTimeZone}/>
        </div>
    );
}
